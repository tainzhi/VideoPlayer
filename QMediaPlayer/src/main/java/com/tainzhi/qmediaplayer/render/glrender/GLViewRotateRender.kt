package com.tainzhi.qmediaplayer.render.glrender
...
import com.tainzhi.qmediaplayer.render.GLRenderViewListener
 ...
 * @mail:        qfq61@qq.com
 * @date:        2020/6/2 16:47
 * @description: 可以旋转播放页面的Render
 **/

class GLViewRotateRender(val glRenderViewListener: GLRenderViewListener) : GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    companion object {
        private const val TAG = "GLViewRotateRender"
