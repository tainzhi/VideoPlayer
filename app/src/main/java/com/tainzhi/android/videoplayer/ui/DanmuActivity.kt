...
class DanmuActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        danmuHelper = DanMuHelper(this, findViewById<DanmuContainerView>(R.id.danmuContainerView))

        findViewById<Button>(R.id.addDanmuBtn).setOnClickListener {
        ...
        findViewById<Button>(R.id.hideDanmuBtn).setOnClickListener {
