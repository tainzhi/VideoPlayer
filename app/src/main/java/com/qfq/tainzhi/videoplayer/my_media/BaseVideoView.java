...
public abstract class BaseVideoView extends FrameLayout implements View.OnClickListener,
		...
		public static BaseVideoView CURREENT_VIDEO_VIEW;
		...
		public void setUp(String url, String title) {
			setUp(new DataSource(url, title), SCREEN_NORMAL);
		}
		...
		public void setUp(DataSource dataSource, int screen) {
			setUp(dataSource, screen, VideoPlayerSystem.class);
		}
		
		public void setUp(String url, String title, int screen, Class mediaInterfaceClass) {
			setUp(new DataSource(url, title), screen, mediaInterfaceClass);
		}
		
		public void setUp( DataSource dataSource, int screen, Class mediaInterfaceClass) {
